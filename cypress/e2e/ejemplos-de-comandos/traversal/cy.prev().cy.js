...
// .prev()
describe('Tests para usar cy.prev() básico', () => {
    beforeEach(() => {
    ...
    it('Debe verificar que el anterior a .active en .birds sea "Lorikeets"', () => {
        // Selecciona el elemento anterior al que tiene clase .active dentro de .birds
        cy.get('.birds')
          .find('.active')
          .prev()
